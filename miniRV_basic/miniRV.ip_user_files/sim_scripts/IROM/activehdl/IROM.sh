...
#
# Script generated by Vivado on Tue Jul 14 15:34:15 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Downloads/miniRV_basic_minisys/miniRV_basic/miniRV.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
